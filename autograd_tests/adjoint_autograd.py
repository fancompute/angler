...
# 'link' solve_fields with its vjp_maker function, which will let us call autograd.grad() on it
defvjp(solve_fields, vjp_maker)
...
if __name__ == '__main__':
    ...
    def J(E):
        return npa.sum(npa.abs(E)) / N

    # the full objective function as a fn of eps_r
    def objective(eps_r):
        E = solve_fields(eps_r)
        return J(E)
    ...
    grad_num = numerical_grad(objective, eps_r, d_eps=1e-4)
