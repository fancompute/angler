...
class Simulation:
    ...
    def __init__(self, omega, eps_r, dl, NPML, pol, L0=DEFAULT_LENGTH_SCALE):
        ...
        self.x_list = [0, float(self.Nx*self.dl)]
        self.y_list = [0, float(self.Ny*self.dl)]
    ...
    def eps_r(self, new_eps):
        ...
        (A, derivs) = construct_A(self.omega, self.x_list, self.y_list,
...
"""
    ...
    def _check_inputs(self):
        ...
        assert len(self.NPML) == 2, "y_list must be a list of length 2, was supplied {}, which is of length {}".format(str(self.NPML), len(self.NPML))
